...
# # What is the index of the first occurrence of the word 'and' in verse?
IndexOfFirstAnd = verse.find('and')
print(IndexOfFirstAnd)

# # What is the index of the last occurrence of the word 'you' in verse?
indexOfLastYou = verse.rfind('you')
...
print('The lenth of the string varibale verse is: 362')

print('The index of the first occurrence of the word "and" is: 65')

print('The index of the last of occurrence of the word "you" is: 186')
